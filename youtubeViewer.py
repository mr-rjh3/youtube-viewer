...
Use: ID = getSuggestedVideo(yt_data, deadends)
----------------------------------------------------------
Parameters:
...
Returns:
    ID - ID of the first suggested video, -1 if video could not be found
----------------------------------------------------------
"""
